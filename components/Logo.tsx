...
function Iconographic({ color = 'white', size = 24, ...otherProps }) {
  return (
    <svg
...
const TypographicMain = ({ color, reserved }) => {
  const { x } = useSpring({ from: { x: 0 }, x: 1, config: { duration: 500 } });
  return (
    <g>
      <animated.path
        style={{
...
const TypographicTagline = ({ color }) => (
  <g>
    ...
    <path
      ...
      fill={color}
    />
    <path d="M105.67,177.2h-1.3v-9H93.63v9H92.35V158.83h1.28V167h10.74v-8.15h1.3Z" fill={color} />
    <path
    ...
    <path
      ...
      fill={color}
    />
    <path d="M195.3,177.2V158.83h1.28V176h8.77v1.2Z" fill={color} />
    <path
...
const Typographic = forwardRef(
  (
    ...
    return (
      <Box ref={ref} color={color} {...otherProps}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={width || size}
          height={height}
          preserveAspectRatio="xMinYMin meet"
          style={style}
          viewBox={reserved ? '0 0 400 150' : '0 0 380 150'}>
          <TypographicMain color="currentColor" reserved={reserved} />
...
export const Logo = { Iconographic, Typographic };
