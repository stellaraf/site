...
import styles from "components/svg/styles.module.scss";

class IconNotFound extends Component {
    constructor(props) {
        super(props);
        this.color = theme.stBackground;
    }
    render() {
        return (
            <svg
                ...
                <defs>
                    ...
                    />
                    <use xlinkHref="#07332201-7176-49c2-9908-6dc4a39c4716" />
                    <linearGradient
