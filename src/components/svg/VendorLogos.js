...
function VMware({ color = "#ffffff", width, height, style, className }) {
    return (
        <svg
            ...
            style={style}
            className={className}
            viewBox="0 0 678 103.4"
            enableBackground="new 0 0 678 103.4"
            ...
            <g fill={color}>
                ...
                <path d="m661.3 8.9c0-.7.6-1.3 1.3-1.3h4c1.5 0 2.7.4 3.4 1.2.7.6 1 1.6 1 2.7 0 1.8-.9 3-2.3 3.6l1.8 2.2c.2.3.4.6.4 1 0 .7-.6 1.2-1.2 1.2s-1-.3-1.3-.7l-2.5-3.2h-2.1v2.5c0 .7-.6 1.3-1.3 1.3s-1.3-.6-1.3-1.3zm5.2 4.4c1.3 0 1.9-.7 1.9-1.7 0-1.1-.7-1.7-2-1.7h-2.6v3.4z" />
            </g>
        </svg>
    );
}
