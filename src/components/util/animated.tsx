...
type MakeMotionProps<P extends BoxProps> = React.PropsWithChildren<Omit<P, "transition"> & Omit<MotionProps, "transition"> & { transition?: Transition }>;
 ...
 */
export function motionChakra<P extends BoxProps = BoxProps>(component: MCComponent, options?: MCOptions): CustomDomComponent<MakeMotionProps<P>> {
