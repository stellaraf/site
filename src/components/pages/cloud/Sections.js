...
const StyledLocPopup = styled(Popover)`
  && {
    ...
    & .arrow {
      ::after {
        ${props =>
          `border-${props.side}-color: ${theme.contentCardBackground};`}
      }
    }
...
const DRPopup = (
  <StyledInfoPopup>
    <Popover.Title>
      {site.pages.cloud.sections.info[2].infoPopup.title}
    </Popover.Title>
    <Popover.Content>
                    ...
                    <ListGroup variant="flush">
                      <ListGroup.Item>
                        <div className="feature-icon">
                          <Icons.IPv6 size="28px" color={theme.stSecondary} />
                        </div>
                      ...
                      <ListGroup.Item>
                        <div className="feature-icon">
                          <Icons.MANRS size="28px" color={theme.stSecondary} />
                        </div>
                        100% MANRS Compliance
                      </ListGroup.Item>
                      <ListGroup.Item>
                        <div className="feature-icon">
                          <GoLocation size={28} color={theme.stSecondary} />
                        </div>
