      ...
      <SectionWrapper>
          ...
          <SectionContainer fluid>
            ...
            <MasonryCards>
              ...
              <Card className="masonry-card">
                ...
                <Card.Body>
                  We specialize in the deployment of enterprise storage
                  platforms and have extensive experience with almost every
                  storage platform on the planet.
                </Card.Body>
              </Card>
              <Card className="masonry-card">
                <Card.Header>
              ...
              <Card className="masonry-card">
                ...
                <Card.Body>
                  ...
                  due to cost, niche features, or lack of time to migrate, we
                  can help! Our engineering team has decades of experience with
              ...
              <Card className="masonry-card">
                ...
                <Card.Body>
                  ...
                  isn't the right fit for your organization, we can still help
                  you with your business continuity planning. As a{" "}
                  <Link href="/services">managed IT provider</Link>, we
                  regularly work with a wide variety of backup & DR platforms.
                </Card.Body>
                <Card.Footer>
                  <div className="brand-container">
                    <Zerto
          ...
          <SectionContainer fluid>
            ...
            <MasonryCards>
              <Card className="masonry-card">
                ...
                <Card.Body>
                  Our network engineering team has deployed or maintained some
                  of the largest campus networks in the world, with just about
                  every serious campus networking vendor there is.
                  <br />
              ...
              <Card className="masonry-card">
                ...
                <Card.Body>
                  We've built massive and successful SD-WANs, implemented layer
                  2 metro WANs, migrated global L3VPNs, and even build our own
                  MPLS network to power the{" "}
                  <Link href="/cloud">Orion cloud platform</Link>. <br />
                  <br />
                  We're also masterfully adept with critical WAN technologies,
                  such as BGP, MPLS, LDP, IS-IS, OSPF, QoS, and most
                  importantly, how to <b>not</b> extend layer 2 over the WAN.
                </Card.Body>
              </Card>
              <Card className="masonry-card">
                <Card.Header>
              ...
              <Card className="masonry-card">
                ...
                <Card.Body>
                  ...
                  and regularly help growing enterprises and cloud providers
                  move from provider aggregate to independent address space.
                  <br />
                  <br />
                  We're also <em>extremely</em> passionate about IPv6
                  deployment, and have implemented dual stack IPv4 & IPv6
                  networks, as well as deployed NAT64 & DNS64, and NPTv6 when
                  the need arises.
                </Card.Body>
              </Card>
            </MasonryCards>
        ...
        >
          <SectionContainer fluid>
            <Row className="section-title-row">
              <Col sm={12} className="section-title-col">
                <h1 className="section-title font-mono">
                  {this.config[2].title}
                </h1>
            ...
            <MasonryCards>
              <Card className="content-bg-dark masonry-card">
                ...
                <Card.Body>
                  ...
                  systems for both simple and complex requirements to automate
                  the boring tasks and remove human error from infrastructure
                  deployment.
                </Card.Body>
                <Card.Footer>
                  <div className="brand-container">
              ...
              <Card className="content-bg-dark masonry-card">
                ...
                <Card.Body>
                  Already have your back end code perfected but the GUI looks
                  like a low-effort Geocities blog? Please, let us help you.
                  From basic CSS framework implementation to a full ReactJS PWA,
                  you can worry about your backend business logic, and we can
                  worry about your <code>div</code>s, your flexboxes, and your
                  custom <code>useState</code> hooks for you.
                </Card.Body>
                <Card.Footer>
                  <div className="brand-container">
                    <DiJsBadge
