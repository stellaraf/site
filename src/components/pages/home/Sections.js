...
const LearnMore = props => (
  <Link href={props.href}>
    <Button variant="outline-light" className="learn-more">
      <FiChevronRight style={{ marginBottom: "0.1em" }} />{" "}
