...
export function forwardRef<E, P>(_Component: React.ForwardRefRenderFunction<E, P>): React.ForwardRefExoticComponent<React.PropsWithoutRef<P> & React.RefAttributes<E>> {
